...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РеквизитОбщаяСуммаВсегоРегл = Новый РеквизитФормы("ОбщаяСуммаВсегоРегл", Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 2)));
	ИзменитьРеквизиты(Новый Массив(РеквизитОбщаяСуммаВсегоРегл));
	...
	РеквизитСуммаВсегоРегл = Новый РеквизитФормы("СуммаВсегоРегл", Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 2)));
	
	// Добавляем реквизит в табличную часть
	ТабЧастьТовары.Реквизиты.Добавить(РеквизитСуммаВсегоРегл);
	
	// Обновляем метаданные табличной части
	ТабЧастьТовары.ОбновитьРеквизиты();
